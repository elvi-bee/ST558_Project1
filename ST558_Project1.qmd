...
A function to query the API that allows the user to change the following items:
...
_ User options: AGEP, GASP, GRPIP, JWAP (time), JWDP (time), and JWMNP
- The function should turn variables into numeric values or time values (use the middle of the
