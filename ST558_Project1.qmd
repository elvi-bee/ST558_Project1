...
# could pull column name from this?
metadata$variables[1:10]

# could pull variable codes from this?
metadata$variables$FER$values[1:10]
...
MultiYear_API_Builder <- function(years, numvars = "AGEP", catvars = "SEX", geo_level = "state", geo_subset){
  ...
  return(as_tibble(parsed[-1, ], .name_repair = ~ parsed[1, ]))
    ...
    # metadata wrangling will go here?
